...
class sensor(object):
    ...
    def readI2c(self):
        _ = self.i2c.read_byte_data(self.i2c_address, self.analog_port_in)  # placeholder und neuen Wert generieren aus Speicher
        time.sleep(0.01)
        val = self.i2c.read_byte_data(self.i2c_address, self.analog_port_in)  # aktueller Wert aus Speicher - zeitpunkt erste Abfrage
        return val
